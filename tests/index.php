...
<script type="application/javascript">
	...
	$('#generateForm').submit(function(event) {
		...
		const testID = '<?php echo GENERATE_FORM_ID ?>';
		const url = "https://gnsit.devtesting.net/tristan-mcgowan-zendesk-to-halo/tests/index.php?testID=" + testID;
		...
		fetch(url)
			.then(response => {
				...
				// Return both the filename and blob for further processing
	...
	$('#conversionForm').submit(function(event) {
		event.preventDefault();
		const testID = '<?php echo CONVERSION_FORM_ID ?>';
		const url = "https://gnsit.devtesting.net/tristan-mcgowan-zendesk-to-halo/tests/index.php?testID=" + testID;
